...
PACKAGECONFIG ??= "embedder-for-target full-dart-sdk fontconfig skshaper stripped lto mode-release"
...
do_configure() {
    ...
    cp ${STAGING_LIBDIR}/${TARGET_SYS}/6.4.0/crtbeginS.o ${S}/buildtools/linux-x64/clang/lib/clang/11.0.0/lib/${FLUTTER_TRIPLE}/
    cp ${STAGING_LIBDIR}/${TARGET_SYS}/6.4.0/crtendS.o ${S}/buildtools/linux-x64/clang/lib/clang/11.0.0/lib/${FLUTTER_TRIPLE}/
}
